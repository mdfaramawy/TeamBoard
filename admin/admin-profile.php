        ...
        <!-- DataTables Example -->
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" id="mobilenumber" name="mobilenumber" class="form-control"  required="required"  maxlength="11" readonly="true" value="<?php echo $row['MobileNumber'];?>">
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                <div class="form-label-group">
                  <input type="date" id="regdate" name="regdate"  class="form-control" readonly="true" required="required" value="<?php echo $row['regdate'];?>">
                  <label for="regdate">User Registration Date</label>
                </div>
              </div>
