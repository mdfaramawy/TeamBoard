...
$query=mysqli_query($con,"update tbluser set Password ='$newpassword' where  id = '$adminid' ");
...
<head>
  ...
  <title>SIT Customers Tracker - Reset Password</title>
...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">SIT Customers Tracker || Reset Password</div>
      <div class="card-body">
