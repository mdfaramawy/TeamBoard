          ...
          <form name="directory" method="post" enctype="multipart/form-data">
              ...
              <div class="form-row">
                <div class="col-md-6">
                  ...
                  <div class="form-label-group">
                    <input type="text" name="cstName" id="cstName" class="form-control wd-450" required="true" autofocus="autofocus" value="<?php echo $row['cstName']; ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <label for="LastUpdate"> Last Update</label>
                  <div class="form-label-group">
                    <input type="date" name="LastUpdate" id="LastUpdate" class="form-control wd-450" required="true" value="<?php echo $row['lastUpdate']; ?>">
                  </div>
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="form-row">
                ...
                <textarea name="notes" style="width:100%;text-align:right" rows="3"><?php echo $row['notes']; ?></textarea>
              </div>
            </div>
            <div class="form-group">
              <div class="form-row">
