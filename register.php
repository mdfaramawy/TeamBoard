...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select username from tbluser where username='$username' ");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This username  associated with another account";
    }
    else{
	$query=mysqli_query($con, "insert into tbluser(FullName, MobileNumber, username,  Password) 
	                                         value('$fname', '$mobno', '$username', '$password' )");
    if ($query) {
...
<body>
    ...
    echo $msg;
						...
						<fieldset>
							...
							<div class="form-group">
								<input class="form-control" placeholder="User Name" name="username" type="username" required="true">
							</div>
							<div class="form-group">
